...
if (require.main === module) {
    ...
    if (translateAPI("foobar") !== undefined) {
    ...
    if (translateAPI("/neuviz/foobar") !== undefined) {
        console.error("router: return something with wrong 2nd param");
        process.exit(1);
    }

    if (translateAPI("/neuviz/1.0/foobar42") !== undefined) {
        console.error("router: return something with wrong 3th param");
        process.exit(1);
    }

    if (translateAPI("/neuviz/1.0/data/foobar") !== undefined) {
